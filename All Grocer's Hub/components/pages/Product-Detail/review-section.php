    ...
    <div class="Review-Section__First-Row">
        <div class="Review-Section__First-Row__Current-Rating">
            <div class="Review-Section__First-Row__Current-Rating__Num-Rating">
                ...
                <div class="Review-Section__First-Row__Current-Rating__Num-Rating__Max">
                    <p>/5</p>
                </div>
            </div>
        ...
        <div class="Review-Section__First-Row__Add-Review">
            ...
            <form class="Review-Section__First-Row__Add-Review__Form" method="POST" action="./product.php?product-id=<?php echo $id; ?>">
                <div class="Review-Section__First-Row__Add-Review__Form__Rating">
                    Select Rating:
                    <input type="radio" name="star-rating" value="1" id="star1" onchange="changeRating(1)" required>
                    <label class="star-label" for="star1">
                        <img src="assets/images/star/filled-star.svg" id="star-number1">
                    </label>
                    <input type="radio" name="star-rating" value="2" id="star2" onchange="changeRating(2)">
                    <label class="star-label" for="star2">
                        <img src="assets/images/star/filled-star.svg" id="star-number2">
                    </label>
                    <input type="radio" name="star-rating" value="3" id="star3" onchange="changeRating(3)">
                    <label class="star-label" for="star3">
                        <img src="assets/images/star/filled-star.svg" id="star-number3">
                    </label>
                    <input type="radio" name="star-rating" value="4" id="star4" onchange="changeRating(4)">
                    <label class="star-label" for="star4">
                        <img src="assets/images/star/filled-star.svg" id="star-number4">
                    </label>
                    <input type="radio" name="star-rating" value="5" id="star5" onchange="changeRating(5)">
                    <label class="star-label" for="star5">
                        <img src="assets/images/star/filled-star.svg" id="star-number5">
                    </label>
                </div>
                ...
                <input type="submit" value="Submit Review" class="btn primary-outline-btn card-btn" name="submit-review" id="submit-review" <?php if (!$canReviewFlag) {
                                                                                                                                                echo "disabled";
                                                                                                                                            } ?>>
            </form>
        </div>
...
function changeRating(value) {
    for (let i = 1; i <= 5; i++) {
        let currentStar = document.getElementById('star-number' + i);
        if (i > value) {
            currentStar.style.opacity = 0.4;
        } else {
