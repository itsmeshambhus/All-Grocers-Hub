    ...
    <div class="page-footer">
            ...
            <div class="page-footer__quick-links">
                ...
                <div class="page-footer__quick-links__links">
                    <ul class="contact-list">
                        <li>
                            <img src="./assets/images/call.png" alt="" width="28px" height="25px"> <a> (+977) 7960640277</a>
                        </li>
                        <li>
        ...
        <div class="page-footer__desc">
            ...
            <div class="page-footer__desc__content" style="text-align: left;">
                The easiest approach to purchase goods made locally. Acquired by Cleckhudderfax dealers. Purchase at any time and from anyplace.
            </div>
